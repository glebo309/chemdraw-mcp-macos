...
Public GitHub hosting was approved on 2026-09-15 for glebo309/chemdraw-mcp-macos, superseding the initial private-only decision. This does not authorize package publication, contacting maintainers, adding collaborators or granting a project licence. Keep private research, proprietary references, credentials and local validation bundles out of repository history. Subsequent pushes require corresponding user scope.
