...
**[Download for Mac (Apple Silicon)](https://github.com/glebo309/chemdraw-mcp-macos/releases/download/v0.10.0rc20/ChemDraw-MCP-Apple-Silicon.dmg)** ·
[Release notes](https://github.com/glebo309/chemdraw-mcp-macos/releases/tag/v0.10.0rc20) ·
...
| Route | Start here |
| --- | --- |
| **Graphical Mac installer** | [Download the Apple Silicon DMG](https://github.com/glebo309/chemdraw-mcp-macos/releases/download/v0.10.0rc20/ChemDraw-MCP-Apple-Silicon.dmg), open **ChemDraw MCP**, and choose your installed ChemDraw app and local assistants. **Start Here.html** beside the app illustrates the macOS opening steps. Python and dependencies are included. |
...
Prefer no terminal? [Download the Mac DMG](https://github.com/glebo309/chemdraw-mcp-macos/releases/download/v0.10.0rc20/ChemDraw-MCP-Apple-Silicon.dmg),
...
**Experimental candidate: 0.10.0rc20.** Requires your own licensed ChemDraw and a
